...
function groupButtons(firstButton, numButtons, groupName, groupLabel = toLabel(groupName)){
	...
	// for the div :)
	div.addEventListener('mouseenter', function(){btn.dispatchEvent(new Event('mouseenter'))});
	div.addEventListener('mouseleave', function(){btn.dispatchEvent(new Event('mouseleave'))});
	...
	btn.addEventListener('click', function(e){e.target.previousSibling.click()})
